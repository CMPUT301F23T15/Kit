...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if(isLoggedIn()){
            ...
            binding.deletebutton.setText(R.string.deleteAccount);
    ...
    /**
     * This method deletes a user account when logged in
       * @param email String representing an email
       * @param password String representing the users password
    */
    ...
    /**
     * This method deletes a user account when logged in
     * but first asks for credentials to authenticate user
     * @param email String representing an email
     * @param password String representing the users password
     */
            ...
            user.reauthenticate(credential)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(ProfileActivity.this);
                            builder.setMessage(R.string.confirmDelAccount)
                                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            user.delete()
